...
def main():
	...
	Memsize_By_Approach_Dict = {"Orion": {"SplitChatBot": 1088, "TrainIntentClassifier": 1664}, "Best_Memory": {"SplitChatBot":8000, "TrainIntentClassifier":8000}, "CherryPick": {"SplitChatBot":5457, "TrainIntentClassifier":1086}}
	BundleSize_By_Approach_Dict = {"Orion": 1, "Best_Memory": 1,  "CherryPick": 1}
	...
	for approach in BundleSize_By_Approach_Dict:
		...
		input_dict_list = []
		f = open("ChatBot_Inputs.json", "r")
		lines = f.readlines()

		for l in lines:
			j = json.loads(l)
			j["bundle_size"] = BundleSize_By_Approach_Dict[approach]
